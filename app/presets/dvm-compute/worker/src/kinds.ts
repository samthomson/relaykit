...
export const KIND = {
  // NIP-C0: the reusable code source lives here. Regular (non-replaceable) kind — the worker
  // resolves the latest by created_at for a given `d`; older versions are not auto-replaced.
  codeSnippet: 1337,
